...
const initialReportsData = [
  {
    ...
    type: 'Security',
    location: 'Sector 12',
    reportedBy: 'Officer A',
    actionTaken: 'Increased patrolling',
    outcome: 'Resolved',
    operationName: 'Operation Shield',
    operationalUnit: 'Alpha Team',
    personnelInvolved: '5',
  ...
  },
  {
    ...
    type: 'Emergency',
    location: 'Sector 15',
    reportedBy: 'Officer C',
    actionTaken: 'Emergency response deployed',
    outcome: 'Mitigated',
    operationName: 'Operation Rescue',
    operationalUnit: 'Charlie Team',
    personnelInvolved: '8',
  ...
  },
  {
    ...
    type: 'Security',
    location: 'Sector 10',
    reportedBy: 'Officer D',
    actionTaken: 'Patrol increased in the area',
    outcome: 'Under investigation',
    operationName: 'Operation Vigil',
    operationalUnit: 'Delta Team',
    personnelInvolved: '6',
  ...
  },
  {
    ...
    type: 'Routine',
    location: 'Sector 5',
    reportedBy: 'Officer E',
    actionTaken: 'Inspection completed',
    outcome: 'No issues found',
    operationName: 'Routine Check',
    operationalUnit: 'Echo Team',
    personnelInvolved: '4',
  ...
  },
  {
    ...
    type: 'Security',
    location: 'Sector 3',
    reportedBy: 'Officer H',
    actionTaken: 'Increased security patrols',
    outcome: 'Resolved',
    operationName: 'Operation Guard',
    operationalUnit: 'Hotel Team',
    personnelInvolved: '5',
    equipmentUsed: 'Patrol Car',
    timeOfReport: '12:00',
  ...
  },
  {
    ...
    outcome: 'Resolved',
    operationName: 'Operation Rescue II',
  ...
  },
  {
    ...
    type: 'Security',
    location: 'Sector 1',
    reportedBy: 'Officer J',
    actionTaken: 'Investigation underway',
    outcome: 'Under investigation',
    operationName: 'Operation Secure',
    operationalUnit: 'Juliet Team',
    personnelInvolved: '4',
  ...
  },
  {
    ...
    type: 'Emergency',
    location: 'Sector 9',
    reportedBy: 'Officer L',
    actionTaken: 'Rescue operation executed',
    outcome: 'Resolved',
    operationName: 'Operation Swift',
  ...
  },
  {
    ...
    type: 'Security',
    location: 'Sector 14',
    reportedBy: 'Officer N',
    actionTaken: 'Enhanced security measures',
    outcome: 'Resolved',
    operationName: 'Operation Fortress',
